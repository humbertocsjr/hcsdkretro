...
install: all
	@install -d $(INSTDIR)
	@install $(filter-out %.dSYM,$(wildcard bin/hcasm-* bin/retrolang-* bin/hclink-* bin/hclib bin/hcbuild)) $(INSTDIR)
	@install -d $(INSTDIR)/libs
	@install $(filter-out %.dSYM,$(wildcard bin/hcasm-* bin/retrolang-* bin/hclink-* bin/hclib bin/hcbuild)) $(INSTDIR)/libs
	@install -d $(LIBSDIR)
	@install libs/*.obj libs/*.lib $(LIBSDIR)
...
distro_win32:
	...
	@cp include/*.rl bin/win32/include/
	@mkdir -p bin/win32/libs
	@cp libs/*.obj bin/win32/libs/
...
distro_macos:
	...
	@cp include/*.rl bin/macos/include/
	@mkdir -p bin/macos/libs
	@cp libs/*.obj bin/macos/libs/
	...
	@cp libs/*.obj bin/pkg/usr/local/share/hcsdk/libs/
...
distro_linux: bin/dpkg/hcsdk/DEBIAN/control
	...
	@cp include/*.rl bin/linux/include/
	@mkdir -p bin/linux/libs
	@cp libs/*.obj bin/linux/libs/
	...
	@cp libs/*.obj bin/dpkg/hcsdk/usr/local/share/hcsdk/libs/
